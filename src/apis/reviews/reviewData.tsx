...
export const reviewData: Review[] = [
    ...
    },
    {
        ...
        value: {
            ...
            reviewerName: "D Synkiw",
            reviewerPfp: "/images/profilePics/silksong.png",
            reviewDesc: "Terribly disappointing. The game feels unfinished, with constant bugs, clunky controls, and repetitive gameplay. It lacks depth and polish, making it hard to recommend.",
            reviewDate: new Date("January 5, 26")
        }
    },        {
        id: "4",
        value: {
            ...
            reviewerName: "Xavier",
            reviewerPfp: "/images/profilePics/XavierPfp.png",
            reviewDesc: "There are some decent ideas here, but they’re overshadowed by technical issues and uneven design. It shows potential, yet the experience feels frustrating more often than fun.",
            reviewDate: new Date("January 5, 26")
        }
    },        {
        id: "5",
        value: {
            ...
            reviewerName: "Shannon",
            reviewerPfp: "/images/profilePics/CUBE.jpg",
            reviewDesc: "An average game overall. The core mechanics work, but nothing stands out. It’s playable and occasionally enjoyable, though it lacks lasting impact.",
            reviewDate: new Date("January 5, 26")
        }
    },        {
        id: "6",
        value: {
            ...
            reviewerName: "D Synkiw",
            reviewerPfp: "/images/profilePics/silksong.png",
            reviewDesc: "A solid experience with noticeable strengths. The gameplay loop is engaging, and while there are minor flaws, it delivers a good amount of entertainment.",
            reviewDate: new Date("January 5, 26")
        }
    },        {
        id: "7",
        value: {
            ...
            reviewerName: "Xavier",
            reviewerPfp: "/images/profilePics/XavierPfp.png",
            reviewDesc: "Very enjoyable and well-executed. The mechanics are polished, progression feels rewarding, and the overall design is cohesive. A strong recommendation for most players.",
            reviewDate: new Date("January 5, 26")
        }
    },        {
        id: "8",
        value: {
            ...
            reviewerName: "Shannon",
            reviewerPfp: "/images/profilePics/CUBE.jpg",
            reviewDesc: "Despite some ambition, the game ultimately falls flat. Repetitive missions and technical issues make it difficult to stay invested.",
            reviewDate: new Date("January 5, 26")
        }
    },        {
        id: "9",
        value: {
            ...
            reviewerName: "D Synkiw",
            reviewerPfp: "/images/profilePics/silksong.png",
            reviewDesc: "Slightly better than a complete miss, but still underwhelming. A few fun moments shine through, though they aren’t enough to redeem the overall experience.",
            reviewDate: new Date("January 5, 26")
        }
    },
]